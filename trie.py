...
# open_files = ['a', 'h', 'p', 'w', 'i', 's']


# def load(letter):
#     with open(files[open_files[-1]], 'w') as json_file:
#         json.dump(dicts[open_files[-1]], json_file)
#
#     dicts[open_files[-1]] = {}
#     open_files[-1] = letter
#     dicts[letter] = json.load(open(files[letter]))
